...
class iPhone1212Pro4 extends StatelessWidget {
  iPhone1212Pro4();
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 66.0, middle: 0.4035),
            child: Text(
              'Explore New startup idea\nthat you may mentor ',
              style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 40.6, middle: 0.5),
            Pin(size: 40.6, middle: 0.4767),
            child: Transform.rotate(
              angle: 3.1241,
              child:
          ...
          Pinned.fromPins(
            Pin(start: 52.0, end: 46.0),
            Pin(size: 119.0, middle: 0.6258),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(34.0),
                color: const Color(0xcc3895a4),
          ...
          Pinned.fromPins(
            Pin(size: 40.6, middle: 0.5232),
            Pin(size: 40.6, middle: 0.6721),
            child: Transform.rotate(
              angle: 3.1241,
              child:
                  // Adobe XD layer: 'Untitled design (51)' (shape)
