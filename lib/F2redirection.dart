...
import './ChoosingRightPerson.dart';
import 'package:adobe_xd/page_link.dart';

class F2redirection extends StatelessWidget {
  F2redirection();
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 0.0, end: 0.0),
            Pin(size: 141.0, end: -71.0),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(47.0),
                color: const Color(0xbdffffff),
                border: Border.all(width: 1.0, color: const Color(0xbdfff8f8)),
                boxShadow: [
                  BoxShadow(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => ChoosingRightPerson(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(width: 1.0, color: const Color(0xccfff8f8)),
                  boxShadow: [
                    BoxShadow(
                      color: const Color(0x21000000),
                      offset: Offset(20, 20),
          ...
          Pinned.fromPins(
            Pin(size: 125.0, start: 55.0),
            Pin(size: 96.0, middle: 0.3048),
            child: Text(
              'Lack Of \nplanning/\nmentorship',
              style: TextStyle(
                fontFamily: 'Segoe UI Variable Display',
          ...
          Pinned.fromPins(
            Pin(size: 126.0, end: 53.0),
            Pin(size: 126.0, middle: 0.5325),
            child:
                // Adobe XD layer: 'Untitled design (52)' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
          ...
          Pinned.fromPins(
            Pin(size: 116.0, start: 58.0),
            Pin(size: 116.0, middle: 0.5383),
            child:
                // Adobe XD layer: 'Untitled design (53)' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
